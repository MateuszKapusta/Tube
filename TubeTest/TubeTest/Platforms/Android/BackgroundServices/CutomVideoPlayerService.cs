...
namespace TubeTest.Platforms.Droid.Services
{
    ...
    public class CutomVideoPlayerService : Service
    {
        ...
        public override StartCommandResult OnStartCommand(Intent? intent, [GeneratedEnum] StartCommandFlags flags, int startId)
        {
            ...
            else if (intent.Action.Equals(Constants.ACTION_RESET_MEDIA))
            {
                Log.Info(nameof(StartCommandResult), "OnStartCommand: Reset the media.");
                WeakReferenceMessenger.Default.Send(new MediaPlayerMessage(new Models.PlayerStatus() { Reet = true }));
            }
        ...
        void RegisterForegroundService()
        {
            ...
            var notification = new Notification.Builder(this, MainApplication.DefaultChannelId.ToString())
                ...
                .SetOngoing(true)
                .AddAction(BuildResetServiceAction())
        ...
        Notification.Action BuildResetServiceAction()
        {
            var stopServiceIntent = new Intent(this, GetType());
            stopServiceIntent.SetAction(Constants.ACTION_RESET_MEDIA);
